...
CREATE TABLE `covid` (
  ...
  `travelled_outside` int(1) NOT NULL,
...
INSERT INTO `covid` (`fname`, `lname`, `address`, `age`, `gender`, `email`, `contact`, `city`, `state`, `pincode`, `travelled_outside`, `symptoms`) VALUES
('rachit', 'saxena', 'noida', 19, 'Male', 'rachit123@gmail.com', 96852658742, 'noida', 'Uttar Pradesh', 166352, 1, 'none');
...
('rachit saxena', 'rachit123@gmail.com', 'naana', 'nana', 'nknkn'),
